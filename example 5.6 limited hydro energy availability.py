...
'P1': [0,50,200,200,10,16,15],
'P2': [0,110,200,200,30,13,12],
'P3': [0,100,200,200,35,10,9],
'hydro':[0,50,50,50,0,5,5]})
...
model.addConstrs((P12[t]+P['P3',t]+P['hydro',t]==load['bus2',t] for t in range(3)),name='bus2_day_ahead_balance')
...
model.addConstrs((rh['P3',t]+rh['hydro',t]+P12h[t]-P12[t]+Lhshed['bus2',t]==0\
...
model.addConstrs((rl['P3',t]+rl['hydro',t]+P12l[t]-P12[t]+Llshed['bus2',t]==0\
...
# 水电能量约束
model.addConstr(gp.quicksum(P['hydro',t]+rh['hydro',t] for t in range(3))<=60,name='hydro_energy_constraint')
model.addConstr(gp.quicksum(P['hydro',t]+rl['hydro',t] for t in range(3))<=60,name='hydro_energy_constraint')
